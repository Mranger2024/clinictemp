...
export function DoctorsModern() {
    return (
        <section id="doctors" className="py-16 md:py-20 bg-background">
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {doctors.slice(0, 3).map((doctor) => {
                        ...
                        return (
                            <Card key={doctor.id} className="group flex flex-col overflow-hidden text-center transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                                <CardContent className="p-6 flex-1 flex flex-col items-center">
                                    {doctorImage && (
                                        <Avatar className="h-32 w-32 mx-auto border-4 border-background shadow-lg transition-transform duration-300 group-hover:scale-110">
